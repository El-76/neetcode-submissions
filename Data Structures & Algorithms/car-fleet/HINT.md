...
Сортируем пары (позиция, скорость) по позиции по убыванию. Начинаем перебирать отсортированный список - получится, что перебираем, начиная с самой близкой машины. Считаем время, которое нужно машине, чтобы достичь цели. Если время меньше или равно времени первой машине в группе, то значит, что данная машина догонит первую в группе и финиширует в одной группе с ней. В противном случае данная машина не догонит группу - увеличиваем число групп на единицу, эта машина становится первой в группе, время теперь сравниваем с её временем.
