...
Основная мысль - тк массив отсортирован, то можно взять 2 индекса (указателя), инициализировав их элементами в начале и в конце. Если сумма этих элементов больше целевой - нужно уменьшить сумму - единственный способ это сделать - переместить правый указатель влево. И наоборот. Важный момент - указатели никогда не надо двигать в обратную сторону, тк если мы например передвинули правый указатель влево и сумма стала меньше целевой, то левый указатель двигать обратно влево и перебирать пропущенные пары не нужно - сумма станет ещё меньше. А если мы передвинули правый указатель влево и сумма по-прежнему больше целевой, то левый указатель двигать влево не нужно тк его ранее передвинули вправо для большего, нежели сейчас значения правого указателя.
