...
Нужно использовать структуру данных "куча", в Java это PriorityQueue. Сложность создания кучи из массива элементов - O(n), сложность извлечения элемента из вершины - O(log n).
