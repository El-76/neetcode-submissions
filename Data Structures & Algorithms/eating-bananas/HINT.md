...
Пользуемся тем фактом, что по мере убывания высоты время неубывает и устраиваем бинарный поиск от максимальной высоты (высота максимальной кучи) до минимальной.
