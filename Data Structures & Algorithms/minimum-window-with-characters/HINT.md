...
Двигаем правую границу окна вправо пока не получится подстрока s, содержащая все симоволы t, запоминаем. Далее двигаем левую границу вправо до тех пор, пока подстрока s не перестанет содержать все символы t. По ходу движения запоминаем минимальную подстроку. Повторяем.
