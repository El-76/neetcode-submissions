...
Используем бинарный поиск - делим массив на 2 части - одна отсортирована, другая - нет. Определяем, находится ли искомое значение в отсортированной части - продолжаем искать в ней, если находится, если нет - продолжаем поис в неотсортированной.
